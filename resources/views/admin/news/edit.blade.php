...
<div class="container-fluid">
    <div class="d-flex align-items-center mb-3">
        ...
        <h2 class="m-0">Chỉnh sửa bài viết</h2>
    </div>
            ...
            <form action="{{ route('news.update', $news->id) }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-md-6">
                        ...
                        @if($news->image)
                            <img src="{{ asset($news->image) }}" alt="Ảnh bài viết" class="mt-2 rounded" style="max-height: 100px;">
                        @endif
                        @error('image')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                ...
                <div class="mb-3">
                    ...
                    <textarea name="content" id="content_">{{ old('content', $news->content) }}</textarea>
                    @error('content')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                </div>
