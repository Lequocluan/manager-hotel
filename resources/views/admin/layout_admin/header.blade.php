        ...
        <li class="nav-item dropdown no-arrow mx-1">
            <a class="nav-link dropdown-toggle" href="#" id="alertsDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                ...
                @if($totalNewBookings > 0)
                    <span class="badge badge-danger badge-counter">{{ $totalNewBookings > 9 ? '9+' : $totalNewBookings }}</span>
                @endif
            </a>
            <div class="dropdown-list dropdown-menu dropdown-menu-right shadow animated--grow-in" aria-labelledby="alertsDropdown">
                ...
                @forelse($newBookings as $booking)
                    <a class="dropdown-item d-flex align-items-center" href="{{ route('booked-rooms.show', $booking->id) }}">
                        <div class="mr-3">
                        ...
                        <div>
                            ...
                            <span class="font-weight-bold">Khách: {{ $booking->name }} - {{ number_format($booking->total_price) }}đ</span>
                        </div>
                    </a>
                @empty
                    <div class="dropdown-item text-gray-500">Không có đơn mới</div>
                @endforelse
                <a class="dropdown-item text-center small text-gray-500" href="{{ route('booked-rooms.index') }}">Xem tất cả</a>
            </div>
        </li>
