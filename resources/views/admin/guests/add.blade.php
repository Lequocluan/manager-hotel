...
<div class="container-fluid">
    <div class="d-flex align-items-center mb-3">
        ...
        <h2 class="m-0">Thêm khách hàng</h2>
    </div>
            ...
            <form action="{{ route('guests.store') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="file" name="avatar" class="form-control @error('avatar') is-invalid @enderror" onchange="previewAvatar(event)">
                        <img id="avatarPreview" src="#" alt="Preview" class="mt-2 rounded shadow-sm" style="max-height: 100px; display: none;">
